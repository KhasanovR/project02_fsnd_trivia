...
from config import db_type, db_username, db_password, db_host, db_port, db_test_name
...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "{}://{}:{}@{}:{}/{}".format(db_type, db_username, db_password, db_host, db_port, db_test_name)
